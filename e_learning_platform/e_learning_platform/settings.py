...
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'static')]  # Directories to search for static files
...
SECRET_KEY = 'django-insecure-8@l2eqb#!v_ai75y10enx1j)$_ot*k%1pljk9(vvcx+uhra+f4'
